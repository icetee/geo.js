/**
 * geo.js - Simple Geolocation API
 * Date 2017-02-17T02:41:36Z
 * 
 * @author Tamás András Horváth <htomy92@gmail.com>
 * @version v0.1.0
 * @link https://github.com/icetee/geo.js#readme
 * @license MIT
 */
  ...
  return e;
    ...
    module.exports = {
      getConstructor: function () {
        function getConstructor(wrapper, NAME, IS_MAP, ADDER) {
          ...
          redefineAll(C.prototype, {
            ...
            forEach: function () {
              function forEach(callbackfn /*, that = undefined */) {
      ...
      getEntry: getEntry,
      setStrong: function () {
        function setStrong(C, NAME, IS_MAP) {
    ...
    exports.f = _dereq_(28) ? Object.defineProperty : function () {
    ...
    module.exports = _dereq_(28) ? Object.defineProperties : function () {
    ...
    exports.f = _dereq_(28) ? gOPD : function () {
    ...
    module.exports = Reflect && Reflect.ownKeys || function () {
      function ownKeys(it) {
    ...
    module.exports = 1 / $parseFloat(_dereq_(103) + '-0') !== -Infinity ? function () {
    ...
    module.exports = $parseInt(ws + '08') !== 8 || $parseInt(ws + '0x16') !== 22 ? function () {
    ...
    if (_dereq_(28)) {
      ...
      var $from = function () {
        function from(source /*, mapfn, thisArg */) {
    ...
    $export($export.S, 'RegExp', { escape: function () {
        function escape(it) {
          return $re(it);
        }
    ...
    $export($export.P + $export.F * forced, 'Array', {
      findIndex: function () {
        function findIndex(callbackfn /*, that = undefined */) {
    ...
    $export($export.P + $export.F * forced, 'Array', {
      find: function () {
        function find(callbackfn /*, that = undefined */) {
          return $find(this, callbackfn, arguments.length > 1 ? arguments[1] : undefined);
        }
    ...
    $export($export.S + $export.F * !_dereq_(54)(function (iter) {
      ...
      from: function () {
        function from(arrayLike /*, mapfn = undefined, thisArg = undefined*/) {
    ...
    if (new Date(NaN) + '' != INVALID_DATE) {
      _dereq_(87)(DateProto, TO_STRING, function () {
        function toString() {
    ...
    if (!(HAS_INSTANCE in FunctionProto)) _dereq_(67).f(FunctionProto, HAS_INSTANCE, { value: function () {
        function value(O) {
    ...
    if (test + '' != '[object z]') {
      _dereq_(87)(Object.prototype, 'toString', function () {
        function toString() {
    ...
    $export($export.P + $export.F * _dereq_(33)(ENDS_WITH), 'String', {
      endsWith: function () {
        function endsWith(searchString /*, endPosition = @length */) {
    ...
    $export($export.P + $export.F * _dereq_(33)(STARTS_WITH), 'String', {
      startsWith: function () {
        function startsWith(searchString /*, position = 0 */) {
    ...
    $JSON && $export($export.S + $export.F * (!USE_NATIVE || $fails(function () {
      ...
      stringify: function () {
        function stringify(it) {
          ...
          if ($replacer || !isArray(replacer)) replacer = function () {
    ...
    $export($export.P, 'Array', {
      includes: function () {
        function includes(el /*, fromIndex = 0 */) {
    ...
    metadata.exp({ defineMetadata: function () {
    ...
    metadata.exp({ deleteMetadata: function () {
    ...
    metadata.exp({ getMetadataKeys: function () {
    ...
    metadata.exp({ getMetadata: function () {
    ...
    metadata.exp({ getOwnMetadataKeys: function () {
        function getOwnMetadataKeys(target /*, targetKey */) {
          return ordinaryOwnMetadataKeys(anObject(target), arguments.length < 2 ? undefined : toMetaKey(arguments[1]));
        }

        return getOwnMetadataKeys;
      }() });
    ...
    metadata.exp({ getOwnMetadata: function () {
    ...
    metadata.exp({ hasMetadata: function () {
    ...
    metadata.exp({ hasOwnMetadata: function () {
        function hasOwnMetadata(metadataKey, target /*, targetKey */) {
          return ordinaryHasOwnMetadata(metadataKey, anObject(target), arguments.length < 3 ? undefined : toMetaKey(arguments[2]));
        }

        return hasOwnMetadata;
      }() });
    ...
    metadata.exp({ metadata: function () {
...
var Geo = function () {
  ...
  _createClass(Geo, [{
    ...
    key: "watchLocation",
    value: function () {
      function watchLocation(opt) {
        var _this = this;

        return new Promise(function (resolve, reject) {
          _this.geo.watchPosition(function (success) {
            resolve(success);
          }, function (err) {
            reject(err);
          }, _this.opt);
    ...
    value: function () {
      function getLocation() {
        ...
        return new Promise(function (resolve, reject) {
          _this2.geo.getCurrentPosition(resolve, reject, _this2.opt);
        });
      }
    ...
    value: function () {
      function getGoogleLocation() {
        var url = "https://www.googleapis.com/geolocation/v1/geolocate?key=" + this.opt.google.api_key,
            opts = {
          method: 'POST'
        };
